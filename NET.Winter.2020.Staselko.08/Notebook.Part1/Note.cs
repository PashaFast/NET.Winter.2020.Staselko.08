...
namespace Notebook.Part1
{
    ...
    public class Note : IComparer<Note>, IEquatable<Note>
    {
        ...
        /// <param name="dateTime">date and time the note was created.</param>
        /// <param name="id">Id.</param>
        public Note(string author, string title, string text, DateTime dateTime, int id)
        {
            this.Author = author;
            this.Title = title;
            this.Text = text;
        ...
        public bool Equals(Note other)
        {
            ...
            return this.Author == other.Author && this.Title == other.Title && this.Text == other.Text && this.DateTime == other.DateTime;
        }
        ...
        public override string ToString() =>
            $"#{this.Id}, {this.Title} was written by {this.Author} in {this.DateTime}. Add has next text {this.Text}";
